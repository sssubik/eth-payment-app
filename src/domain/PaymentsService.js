import {Payments} from "../constants/contractConfig"
...
class PaymentsService {
    createContract = async function () {
        ...
        const contract = await new web3.eth.Contract(Payments.abi)
    ...
    pay = async function (address, reference, amount) {
        ...
        try {
            const accounts = await web3.eth.getAccounts()
            const contract = await new web3.eth.Contract(Payments.abi, address)
